<template>
    ...
    <section class="article-hero" v-else>
      <div class="article-header-container">
        ...
        <h1>{{ artikel.nama }}</h1>
        <!-- <div class="article-meta">
          <span>Oleh: Editor Catpedia</span>
          <span class="separator">|</span>
          <span>ID Artikel: {{ artikel.id }}</span>
        </div> -->
      </div>
    </section>
    ...
    <section class="article-content-wrapper" v-if="!isError">
      <div class="main-article-content">
        <img :src="artikel.img_url" :alt="artikel.nama" class="article-main-image" />
  ...
  .article-hero {
    ...
    margin-top: -20px; /* Overlap with Navbar if needed, depends on actual Navbar CSS */
    display: flex;
  ...
  /* Main Content Layout (Flex/Grid for Content + Sidebar) */
  ...
  .main-article-content {
    flex: 3;
    min-width: 0; /* Ensures proper responsiveness in flex container */
  }
  ...
  @media (max-width: 900px) {
    ...
    .sidebar-related-articles {
      max-width: 100%;
      order: 2; /* Move sidebar below main content on smaller screens */
    }
