      ...
      <div v-else>
        <div class="profile-card">
          ...
          <div class="profile-content">
            <img :src="getProfileImage(catData.catImage)" alt="Foto Kucing" class="cat-photo" />
            <div class="cat-info">
        ...
        <div v-for="week in 3" :key="week" class="week-card"
          ...
          <div v-else>
            ...
            <button v-if="!isExpired(week)" class="submit-btn" @click="submitForm(week)" :disabled="uploading">
